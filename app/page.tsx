  ...
  return (
   <div className="bg-black">
      <section className="pt-28 sm:pt-32 relative min-h-screen grid grid-cols-1 lg:grid-cols-5 px-4 sm:px-8 pb-20 overflow-hidden ">
        ...
        <div className="col-span-full lg:col-span-3 flex flex-col items-center justify-center text text-center lg:-rotate-2">
          <Badge variant='gold'>Power By AI - Now in Beta</Badge>
        ...
        <div className="col-span-full lg:col-span-2 flex items-center justify-center lg:justify-start mt-12 lg:mt-0 lg:rotate-3">
            <CodeDemo duration={30000} writing delay={0} cursor/>
        </div>
      </section>
      <section className="relative z-10 border-y border-white/10 py-14 bg-black">
        ...
        <div className="grid md:grid-cols-2 gap-6">
           {ROLES.map((role)=>(
            <div
              ...
              key={role.label}
            >
              <span className="inline-block text-xs font-semibold text-amber-400 tracking-widest uppercase border border-amber-400/20 bg-amber-400/10 rounded-full px-3 py-1.5 mb-5">{role.label}</span>
              ...
              <ul>
                {role.perks.map((p)=>(
                  <li key={p} className="flex gap-3 text-sm text-stone-400 pb-2.5">
                    <span className="mt-0.5 min-w-4 h-4 rounded-full bg-amber-400/10 border border-amber-400/20 flex items-center justify-center text-xs text-amber-400">✓</span>
                    {p}
                  </li>
                ))}
              </ul>
